...
description: >-
  ...
  - *[NEW - 3.2.2]* Fixed a startup initialization crash (LastGcTime nil error).
...
********************************************************************************
    ...
    -> 3.2.2    by: n0way02 (https://ko-fi.com/n0way02)
                Fixed a startup initialization crash where LastGcTime was not initialized.
